  ...
  geocoder.geocode({address: address}, function(results, status) {
    if (status === google.maps.GeocoderStatus.OK) {
	  ...
	  //google.maps.event.addListener(marker, 'click', function(event) {
			...
			//var daddr = address.replace(" ", "+");
			
			infoWindow.setContent('<small><table style=\"width:250px\"><b><tr><td>' +store_type + '<br><a href=\"http://maps.google.com?saddr='+saddr+'&daddr='+address+'\", target=\"_blank\" onClick=\"ga(\'send\',\'event\',\'link\',\'directions\','+this.href+')\">'+ store + '<br><font size="1">(click for directions)</font></a></b><br><a href=\"tel:'+ phone +'\" onClick=\"ga(\'send\',\'event\',\'link\',\'phone\','+this.href+')\">' + phone + '</a><br><a href=\"' + website + '\", target=\"_blank\">'+ website +  '</a></td></tr><tr><td>' + product  + '<br>' + description + '<br>' + price + '</td></tr></small></table>');
         
            //infoWindow.setContent('<small><table style=\"width:200px\"><b><tr><td><a href=\"http://maps.google.com?q=' + address + '\", target=\"_blank\" onClick=\"ga(\'send\',\'event\',\'link\',\'store\')\">'+ store + '<br><font size="1">(click for directions)</font></a></b><td>'+ phone +'<br><a href=' + website + ', target=\"_blank\">' + website + '</a><br>'+ store_type +'</td></tr><tr><td>' + product  + '<br>' + description + '</td><td>' + price + '</td></tr></small></table>');
    ...
    <script type='text/javascript'>
      ...
      //<![CDATA[
        ...
        $(function() {
		  ...
		  var prevAddr = '';
		  function addrChange() {
		    if (inAddrChange) {return;}
			if (prevAddr == $('#search_address').val()) {return;}
			  inAddrChange = true;
		  ...
		  $('#search_address').on('click, change', function () {
		      setTimeout(function() {addrChange();}, 500);
          });
		  ...
		  function textChange() {
			  ...
			  if (prevText == $('#text_search').val()) {return;}
		  ...
		  $('#text_search').on('click, change', function () {
              setTimeout(function() {textChange();}, 500);
