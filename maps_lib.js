(function (window, undefined) {
    ...
    MapsLib.prototype.setRadius = function (map) {
		...
		if (map.getZoom() == 4) self.searchRadius = 1610000;
		else if (map.getZoom() == 5) self.searchRadius = 805000;
		else if (map.getZoom() == 6) self.searchRadius = 402500;
		else if (map.getZoom() == 7) self.searchRadius = 161000;
		else if (map.getZoom() == 8) self.searchRadius = 80500;
		else if (map.getZoom() == 9) self.searchRadius = 40250;
		else if (map.getZoom() == 10) self.searchRadius = 20125;
		else if (map.getZoom() == 11) self.searchRadius = 16100;
		else if (map.getZoom() == 12) self.searchRadius = 8050;
		else if (map.getZoom() == 13) self.searchRadius = 3220;
		else if (map.getZoom() == 14) self.searchRadius = 1610;
		else if (map.getZoom() == 15) self.searchRadius = 805;
		else if (map.getZoom() == 16) self.searchRadius = 400;
	}
